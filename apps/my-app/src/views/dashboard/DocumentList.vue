...
import {DocumentListItem, DocumentService} from './DocumentList';

onMounted(() => {
  DocumentService.getDocumentsWithCount().then((data) => (documents.value = data));
});
...
<template>
  <div>
    <DataView :value="documents" :dataKey="'id'" paginator :rows="5">
      <template #list="slotProps">
        <div class="flex flex-col">
          <div v-for="(item, index) in slotProps.items" :key="index">
            <article class="px-4 py-6 shadow sm:rounded-lg sm:p-6">
              <div>
                ...
                <h2 id="question-title-81614" class="mt-4 text-base font-medium">You should use alpinejs framework</h2>
              </div>
  ...
  <path fill-rule="evenodd" d="M.664 10.59a1.651 1.651 0 010-1.186A10.004 10.004 0 0110 3c4.257 0 7.893 2.66 9.336 6.41.147.381.146.804 0 1.186A10.004 10.004 0 0110 17c-4.257 0-7.893-2.66-9.336-6.41zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"></path>
                            ...
                            <span class="font-medium">2.7k</span>
